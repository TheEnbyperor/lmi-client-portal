"""
Django settings for lmi_client_portal project.
...
SECRET_KEY = '1=qe64dr#pb)6w_lgt9j!@czwm7mygc!tz!5i62*#4*f5wxqz%'
...
ROOT_URLCONF = 'lmi_client_portal.urls'
...
WSGI_APPLICATION = 'lmi_client_portal.wsgi.application'
